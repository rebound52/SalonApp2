...
class ServiceRoomRepositoryTest {
    ...
    private lateinit var repository: ServiceRoomRepository
    ...
    fun createDb() {
        ...
        repository = ServiceRoomRepository(serviceDao)
    }
    ...
    @Test
    fun getAllServices_returnsAll() = runBlocking {
    ...
    @Test
    fun getAllServices_byCategory_returnsCorrect() = runBlocking {
        ...
        val cat1Services = repository.getAllServices("cat1")
